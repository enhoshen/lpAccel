...
//      version:		2008Q3V1
//      comment:		
//      configuration:	 -instname "RF_2P_48x16" -words 48 -bits 16 -frequency 400 -ring_width 2.0 -mux 1 -write_mask off -wp_size 8 -top_layer "met5-9" -power_type rings -horiz met3 -vert met2 -redundancy off -rcols 1 -rrows 0 -bmux off -ema on -cust_comment "" -bus_notation on -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,VSS:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type VSS -drive 4 -dpccm on -asvm off -corners ff_1.1_-40.0,ff_1.1_125.0,tt_1.0_25.0,ss_0.9_125.0
//
//      Verilog model for Synchronous Dual-Port Register File
//
//      Instance Name:              RF_2P_48x16
//      Words:                      48
//      Bits:                       16
//      Mux:                        1
//      Drive:                      4
...
//      Test Muxes                  Off
//
//      Creation Date:  2017-10-25 11:45:56Z
//      Version: 	2008Q3V1
//
